...
//					}
	...
	public @ResponseBody Object selectOrderPerson(String phone) {
		String message = "成功";
		String code = "1000";
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			List<Object> list = dao.getAllObject("from OrderInfo o where o.user_id='"+phone+"' order by o.create_time desc");
