...
public class SmsUtils
{
	...
	private static String userid = "E101DL";
	// 用户密码
	private static String pwd = "2BuLfW";
	
	//主IP信息  必填
	private static String masterIpAddress="api02.monyun.cn:7901/sms/v2/std/";
	//备IP1  选填
	private static String ipAddress1="api01.monyun.cn:7901/sms/v2/std/";
	...
	{
		// 用户账号
		String userid = "E101DL";
		// 用户密码
		String pwd = "2BuLfW";
		
		//主IP信息  必填
		String masterIpAddress="api02.monyun.cn:7901/sms/v2/std/";
		//备IP1  选填
	 ...
	 */
	public static void singleSend(String phone, String content)
	{
		try
		{
			// 参数类
			...
			// 设置内容
			message.setContent("您的验证码是"+content+"，在5分钟内有效。如非本人操作请忽略本短信。");
			// 设置扩展号
			message.setExno("11");
			// 用户自定义流水编号
			//message.setCustid(new Timestamp(date.getTime())+"");
			// 自定义扩展数据
			//message.setExdata("便利通");
			//业务类型
